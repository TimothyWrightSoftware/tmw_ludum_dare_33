...
set INCLUDE_FILES=-I%PROJECT%\include -IC:\game_dev\3rd\sdl\dev\SDL2-2.0.3\include -IC:\game_dev\3rd\sdl\dev\SDL2_ttf-2.0.12\include
...
set LIBRARY_FILES=C:\game_dev\3rd\sdl\dev\sdl2-2.0.3\lib\x64\sdl2.lib C:\game_dev\3rd\sdl\dev\sdl2-2.0.3\lib\x64\sdl2main.lib C:\game_dev\3rd\sdl\dev\SDL2_ttf-2.0.12\lib\x64\SDL2_ttf.lib
